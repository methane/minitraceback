...
HAS_NOTE = sys.version_info[:2] >= (3, 11)


def test_extract_tb():
    e = sub.f1()
    tbs = minitraceback.extract_tb(e.__traceback__)
    assert tbs[0] == ("sub/__init__.py", 23, "f3")
    assert tbs[1] == ("sub/__init__.py", 19, "f2")
    assert tbs[2] == ("sub/__init__.py", 10, "f1")
    assert len(tbs) == 3
...
def test_format_frames():
    ...
    assert lines[0] == "sub/__init__.py:23 f3"
    assert lines[1] == "sub/__init__.py:19 f2"
    assert lines[2] == "sub/__init__.py:10 f1"
    assert len(lines) == 3
...
def test_format_tb():
    ...
    assert formatted_tb[0] == "  sub/__init__.py:23 f3"
    assert formatted_tb[1] == "  sub/__init__.py:19 f2"
    assert formatted_tb[2] == "  sub/__init__.py:10 f1"
...
def test_print_tb():
    ...
    expected_output += "  sub/__init__.py:23 f3\n"
    expected_output += "  sub/__init__.py:19 f2\n"
    expected_output += "  sub/__init__.py:10 f1\n"
...
sub.HogeError: foobar
  this is note
Traceback (most recent call first):
  sub/__init__.py:23 f3
  sub/__init__.py:19 f2
  sub/__init__.py:10 f1
"""
    else:
        expected_value = """\
sub.HogeError: foobar
